...
const ArticleList = () => {
    ...
    return (
        <div className='min-h-screen bg-grey-50'>
            <div className="container mx-auto py-16 border-b border-b-grey-300">
                <h2 className='text-3xl font-bold mb-2'>
                    Featured Article
                </h2>
                {featuredArticles.length &&
                <div className='grid gap-x-12 gap-y-4 grid-cols-2'>
                    ...
                    <div className=" divide-y divide-grey-300 flex flex-col max-h-full">
                        ...
                        <Link to={"/articles/"+article.id} className='w-full h-full py-4 flex items-start justify-center flex-row gap-4 group' key={article.id}>
                            <div className="max-w-64 w-auto aspect-video overflow-hidden">
                            ...
                            <div className=''>
                                ...
                                <p className='font-semibold text-grey-800 line-clamp-2 group-hover:underline mt-1'>{article.title}</p>
